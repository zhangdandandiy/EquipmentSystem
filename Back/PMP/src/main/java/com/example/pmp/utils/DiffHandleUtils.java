...
public class DiffHandleUtils {
    ...
    public static void generateDiffHtml(List<String> diffString, String htmlPath) {
        ...
        //如果打开html为空白界面，可能cdn加载githubCss失败 ,githubCss 链接可替换为 https://cdn.jsdelivr.net/gh/1506085843/fillDiff@master/src/main/resources/css/github.min.css
        String githubCss = "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.7.1/styles/github.min.css";
        //如果打开html为空白界面，可能cdn加载diff2htmlCss失败 ,diff2htmlCss 链接可替换为 https://cdn.jsdelivr.net/gh/1506085843/fillDiff@master/src/main/resources/css/diff2html.min.css
        String diff2htmlCss = "https://cdn.jsdelivr.net/npm/diff2html/bundles/css/diff2html.min.css";
        //如果打开html为空白界面，可能cdn加载diff2htmlJs失败, diff2htmlJs 链接可替换为 https://cdn.jsdelivr.net/gh/1506085843/fillDiff@master/src/main/resources/js/diff2html-ui.min.js
    ...
    // 将字符串数组保存至txt文本文件中
    public static void saveArrayToFile(String[] dataArr, String fileName) {
        // 将数组元素转换为字符串形式
        ...
        // 保存为 .txt 文件
        try {
            File file = new File("C:\\PMP\\PMP\\back\\stationFile\\" + fileName);
